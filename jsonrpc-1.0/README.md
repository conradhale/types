...
GJS TypeScript type definitions for Jsonrpc-1.0, generated from library version 3.44.1 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.0.0-beta.36.
