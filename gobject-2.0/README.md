...
GJS TypeScript type definitions for GObject-2.0, generated from library version 2.84.4 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.0.0-beta.33.
