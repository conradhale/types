...
GJS TypeScript type definitions for Notify-0.7, generated from library version 0.8.6 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.0.0-beta.34.
