...
GJS TypeScript type definitions for GMime-3.0, generated from library version 3.2.14 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.0.0-beta.27.
