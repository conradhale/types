...
GJS TypeScript type definitions for PackageKitGlib-1.0, generated from library version 1.2.8 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.0.0-beta.27.
