...
GJS TypeScript type definitions for Template-1.0, generated from library version 3.36.4 using [ts-for-gir](https://github.com/gjsify/ts-for-gir) v4.0.0-beta.26.
