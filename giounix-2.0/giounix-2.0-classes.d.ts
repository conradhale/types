import type GioUnix from './giounix-2.0.d.ts';
...
declare namespace classes {
    class DesktopAppInfo extends GObjectClasses.Object implements Gio.AppInfo {
         ...
         */
        '$signals': GioUnix.DesktopAppInfo.SignalSignatures;
        // Constructors
        constructor(properties?: Partial<GioUnix.DesktopAppInfo.ConstructorProps>, ...args: any[]);
        _init(...args: any[]): void;
        static new(desktop_id: string): GioUnix.DesktopAppInfo;
        static new_from_filename(filename: string): GioUnix.DesktopAppInfo;
        static new_from_keyfile(key_file: GLib.KeyFile): GioUnix.DesktopAppInfo;
        // Signals
        connect<K extends keyof GioUnix.DesktopAppInfo.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, GioUnix.DesktopAppInfo.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: any): number;
        connect_after<K extends keyof GioUnix.DesktopAppInfo.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, GioUnix.DesktopAppInfo.SignalSignatures[K]>,
        ): number;
        connect_after(signal: string, callback: any): number;
        emit<K extends keyof GioUnix.DesktopAppInfo.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<GioUnix.DesktopAppInfo.SignalSignatures[K]>
        ): void;
         ...
         * @param _appinfo2 the second [iface`Gio`.AppInfo].
         */
        equal(_appinfo2: Gio.AppInfo): boolean;
        /**
         * Gets the commandline with which the application will be
         * started.
         *
         * @returns a string containing the `appinfo’`s
         ...
         *
         * @returns the default [iface`Gio`.Icon] for
         ...
         * @param _appinfo2 the second [iface`Gio`.AppInfo].
         */
        vfunc_equal(_appinfo2: Gio.AppInfo): boolean;
        /**
         * Gets the commandline with which the application will be
         * started.
         */
    ...
    class FDMessage extends GioClasses.SocketControlMessage {
         ...
         * It is not defined at runtime and should not be accessed in JS code.
         */
        '$signals': GioUnix.FDMessage.SignalSignatures;
        // Constructors
        constructor(properties?: Partial<GioUnix.FDMessage.ConstructorProps>, ...args: any[]);
        _init(...args: any[]): void;
        static new(): GioUnix.FDMessage;
        static new_with_fd_list(fd_list: Gio.UnixFDList): GioUnix.FDMessage;
        // Signals
        connect<K extends keyof GioUnix.FDMessage.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, GioUnix.FDMessage.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: any): number;
        connect_after<K extends keyof GioUnix.FDMessage.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, GioUnix.FDMessage.SignalSignatures[K]>,
        ): number;
        connect_after(signal: string, callback: any): number;
        emit<K extends keyof GioUnix.FDMessage.SignalSignatures>(
            signal: K,
    ...
    class InputStream extends GioClasses.InputStream implements Gio.PollableInputStream, GioUnix.FileDescriptorBased {
         ...
         * It is not defined at runtime and should not be accessed in JS code.
         */
        '$signals': GioUnix.InputStream.SignalSignatures;
        // Constructors
        constructor(properties?: Partial<GioUnix.InputStream.ConstructorProps>, ...args: any[]);
        _init(...args: any[]): void;
        static new(fd: number, close_fd: boolean): GioUnix.InputStream;
        // Signals
        connect<K extends keyof GioUnix.InputStream.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, GioUnix.InputStream.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: any): number;
        connect_after<K extends keyof GioUnix.InputStream.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, GioUnix.InputStream.SignalSignatures[K]>,
        ): number;
        connect_after(signal: string, callback: any): number;
        emit<K extends keyof GioUnix.InputStream.SignalSignatures>(
            signal: K,
         ...
         * override one you must override all.
         *
         * @param io_priority the [I/O priority](iface.AsyncResult.html#io-priority)
         * of the request.
         * @param cancellable optional #GCancellable object, %NULL to ignore.
         */
        read_async(
    ...
    class MountMonitor extends GObjectClasses.Object {
         ...
         * It is not defined at runtime and should not be accessed in JS code.
         */
        '$signals': GioUnix.MountMonitor.SignalSignatures;
        // Constructors
        constructor(properties?: Partial<GioUnix.MountMonitor.ConstructorProps>, ...args: any[]);
        _init(...args: any[]): void;
        static new(): GioUnix.MountMonitor;
        // Signals
        connect<K extends keyof GioUnix.MountMonitor.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, GioUnix.MountMonitor.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: any): number;
        connect_after<K extends keyof GioUnix.MountMonitor.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, GioUnix.MountMonitor.SignalSignatures[K]>,
        ): number;
        connect_after(signal: string, callback: any): number;
        emit<K extends keyof GioUnix.MountMonitor.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<GioUnix.MountMonitor.SignalSignatures[K]>
        ): void;
        emit(signal: string, ...args: any[]): void;
        // Static methods
        /**
        ...
        implements Gio.PollableOutputStream, GioUnix.FileDescriptorBased
    {
         ...
         * It is not defined at runtime and should not be accessed in JS code.
         */
        '$signals': GioUnix.OutputStream.SignalSignatures;
        // Constructors
        constructor(properties?: Partial<GioUnix.OutputStream.ConstructorProps>, ...args: any[]);
        _init(...args: any[]): void;
        static new(fd: number, close_fd: boolean): GioUnix.OutputStream;
        // Signals
        connect<K extends keyof GioUnix.OutputStream.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, GioUnix.OutputStream.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: any): number;
        connect_after<K extends keyof GioUnix.OutputStream.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, GioUnix.OutputStream.SignalSignatures[K]>,
        ): number;
        connect_after(signal: string, callback: any): number;
        emit<K extends keyof GioUnix.OutputStream.SignalSignatures>(
            signal: K,
