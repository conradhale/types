...
export namespace Mtk {
    ...
    class Rectangle {
         ...
         * @param _src2 The second rectangle
         */
        equal(_src2: Rectangle): boolean;
        free(): void;
        /**
         ...
         * @param _rect2 The second rectangle
         */
        horiz_overlap(_rect2: Rectangle): boolean;
        /**
         * Find the intersection between the two rectangles
         *
         * @returns TRUE is some intersection exists and is not degenerate, FALSE
         *   otherwise.
         * @param _src2 another #MtkRectangle
         */
        intersect(_src2: Rectangle): [boolean, Rectangle];
         ...
         * @param _rect2 The second rectangle
         */
        overlap(_rect2: Rectangle): boolean;
         ...
         *
         * @param _rect2 another #MtkRectangle
         */
        union(_rect2: Rectangle): [Rectangle];
        /**
         ...
         * @param _rect2 The second rectangle
         */
        vert_overlap(_rect2: Rectangle): boolean;
    }
