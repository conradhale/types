import type GjsPrivate from './gjsprivate-1.0.d.ts';
...
declare namespace classes {
    class DBusImplementation extends GioClasses.DBusInterfaceSkeleton implements Gio.DBusInterface {
         ...
         */
        '$signals': GjsPrivate.DBusImplementation.SignalSignatures;
        // Constructors
        constructor(properties?: Partial<GjsPrivate.DBusImplementation.ConstructorProps>, ...args: any[]);
        _init(...args: any[]): void;
        // Signals
        connect<K extends keyof GjsPrivate.DBusImplementation.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, GjsPrivate.DBusImplementation.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: any): number;
        connect_after<K extends keyof GjsPrivate.DBusImplementation.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, GjsPrivate.DBusImplementation.SignalSignatures[K]>,
        ): number;
        connect_after(signal: string, callback: any): number;
        emit<K extends keyof GjsPrivate.DBusImplementation.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<GjsPrivate.DBusImplementation.SignalSignatures[K]>
        ): void;
