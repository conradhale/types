...
export namespace HarfBuzz {
     ...
     * @param draw_data associated draw data passed by the caller
     * @param st current draw state
     * @param _control1_x X component of first control point
     * @param _control1_y Y component of first control point
     * @param _control2_x X component of second control point
     * @param _control2_y Y component of second control point
     ...
     *
     * @returns The new face object, or `NULL` if
     ...
     * @param _x0 X coordinate of the first point
     * @param _y0 Y coordinate of the first point
     * @param _x1 X coordinate of the second point
     * @param _y1 Y coordinate of the second point
     * @param _x2 X coordinate of the third point
     * @param _y2 Y coordinate of the third point
     */
     ...
     * @param paint_data associated data passed by the caller
     * @param color_line Color information for the gradient
     * @param _x0 X coordinate of the first circle's center
     * @param _y0 Y coordinate of the first circle's center
     * @param _r0 radius of the first circle
     * @param _x1 X coordinate of the second circle's center
     * @param _y1 Y coordinate of the second circle's center
     * @param _r1 radius of the second circle
     */
     ...
     * @param paint_data associated data passed by the caller
     * @param color_line Color information for the gradient
     * @param _x0 X coordinate of the circle's center
     * @param _y0 Y coordinate of the circle's center
    ...
    export type font_get_glyph_h_origins_func_t = font_get_glyph_origins_func_t;
    ...
    export type font_get_glyph_v_origins_func_t = font_get_glyph_origins_func_t;
