...
declare namespace classes {
    ...
    class Entry extends Widget implements Atk.ImplementorIface, Clutter.Animatable {
        ...
        _init(...args: any[]): void;
        static new(text?: string | null): St.Entry;
    ...
    class IconInfo extends GObjectClasses.Object {
         ...
         * version of this call.
         *
         * @param colors an #StIconColors representing the foreground, error and
    ...
    class IconTheme extends GObjectClasses.Object {
         ...
         */
        choose_icon(icon_names: string[], size: number, flags: St.IconLookupFlags | null): St.IconInfo | null;
        /**
         ...
         * @param flags flags modifying the behavior of the icon lookup
         */
        load_icon(icon_name: string, size: number, flags: St.IconLookupFlags | null): GdkPixbuf.Pixbuf | null;
        /**
         ...
         *
         * @returns a #StIconInfo containing
         *     information about the icon.
         * @param icon the #GIcon to look up
         * @param size desired icon size
         * @param flags flags modifying the behavior of the icon lookup
         */
        lookup_by_gicon(icon: Gio.Icon, size: number, flags: St.IconLookupFlags | null): St.IconInfo | null;
        /**
         * Looks up an icon and returns a #StIconInfo containing information
         ...
         * @param flags flags modifying the behavior of the icon lookup
         */
        lookup_icon(icon_name: string, size: number, flags: St.IconLookupFlags | null): St.IconInfo | null;
        /**
    ...
    class Label extends Widget implements Atk.ImplementorIface, Clutter.Animatable {
        ...
        _init(...args: any[]): void;
        static new(text?: string | null): St.Label;
        // Conflicted with Clutter.Actor.new
        static new(...args: never[]): any;
        // Signals
         ...
         * can be set.
         *
         * @returns the #ClutterText used by #StLabel. The actor
        ...
        implements Atk.ImplementorIface, Clutter.Animatable
    {
         ...
         */
        set_child(child?: St.Scrollable | null): void;
        /**
    ...
    class TextureCache extends GObjectClasses.Object {
         ...
         * @param theme_node The #StThemeNode to use for colors, or %NULL
    ...
    class ThemeNode extends GObjectClasses.Object {
         ...
         */
        get_background_image_shadow(): St.Shadow | null;
        /**
         ...
         *
         * @returns the parent #StThemeNode, or %NULL if
         *  this is the root node of the tree of theme elements.
         */
        get_parent(): St.ThemeNode | null;
        /**
         ...
         */
        get_shadow(property_name: string): St.Shadow | null;
        /**
         ...
         */
        get_text_shadow(): St.Shadow | null;
        /**
         ...
         * @param other a different #StThemeNode
         */
        paint_equal(other?: St.ThemeNode | null): boolean;
        /**
        ...
        implements Atk.ImplementorIface, Clutter.Animatable
    {
         ...
         */
        navigate_focus(from: Clutter.Actor | null, direction: St.DirectionType | null, wrap_around: boolean): boolean;
        /**
