...
declare namespace classes {
    abstract class Listener extends GObjectClasses.Object {
         ...
         */
        '$signals': PolkitAgent.Listener.SignalSignatures;
        // Constructors
        constructor(properties?: Partial<PolkitAgent.Listener.ConstructorProps>, ...args: any[]);
        _init(...args: any[]): void;
        // Signals
        connect<K extends keyof PolkitAgent.Listener.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, PolkitAgent.Listener.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: any): number;
        connect_after<K extends keyof PolkitAgent.Listener.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, PolkitAgent.Listener.SignalSignatures[K]>,
        ): number;
        connect_after(signal: string, callback: any): number;
        emit<K extends keyof PolkitAgent.Listener.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<PolkitAgent.Listener.SignalSignatures[K]>
        ): void;
         ...
         */
        register(
            flags: PolkitAgent.RegisterFlags | null,
    ...
    class Session extends GObjectClasses.Object {
         ...
         * It is not defined at runtime and should not be accessed in JS code.
         */
        '$signals': PolkitAgent.Session.SignalSignatures;
        // Constructors
        constructor(properties?: Partial<PolkitAgent.Session.ConstructorProps>, ...args: any[]);
        _init(...args: any[]): void;
        static new(identity: Polkit.Identity, cookie: string): PolkitAgent.Session;
        // Signals
        connect<K extends keyof PolkitAgent.Session.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, PolkitAgent.Session.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: any): number;
        connect_after<K extends keyof PolkitAgent.Session.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, PolkitAgent.Session.SignalSignatures[K]>,
        ): number;
        connect_after(signal: string, callback: any): number;
        emit<K extends keyof PolkitAgent.Session.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<PolkitAgent.Session.SignalSignatures[K]>
        ): void;
        emit(signal: string, ...args: any[]): void;
        // Methods
        /**
    ...
    class TextListener extends Listener implements Gio.Initable {
         ...
         * It is not defined at runtime and should not be accessed in JS code.
         */
        '$signals': PolkitAgent.TextListener.SignalSignatures;
        // Constructors
        constructor(properties?: Partial<PolkitAgent.TextListener.ConstructorProps>, ...args: any[]);
        _init(...args: any[]): void;
        static new(cancellable?: Gio.Cancellable | null): PolkitAgent.TextListener;
        // Signals
        connect<K extends keyof PolkitAgent.TextListener.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, PolkitAgent.TextListener.SignalSignatures[K]>,
        ): number;
        connect(signal: string, callback: any): number;
        connect_after<K extends keyof PolkitAgent.TextListener.SignalSignatures>(
            signal: K,
            callback: GObject.SignalCallback<this, PolkitAgent.TextListener.SignalSignatures[K]>,
        ): number;
        connect_after(signal: string, callback: any): number;
        emit<K extends keyof PolkitAgent.TextListener.SignalSignatures>(
            signal: K,
            ...args: GObject.GjsParameters<PolkitAgent.TextListener.SignalSignatures[K]>
        ): void;
        emit(signal: string, ...args: any[]): void;
        // Inherited methods
        /**
